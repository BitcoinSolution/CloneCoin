...
unsigned int nTargetSpacing = 1 * 90; // CloneCoin - 1.5 minute blocks
static const int64_t nInterval = nTargetTimespan / nTargetSpacing;
static const int64_t nDiffChangeTarget = 1;

unsigned int nStakeMinAge = 8 * 60 * 60; // 8 hours
unsigned int nStakeMaxAge = 60 * 60 * 24 * 30;  // 30 days
unsigned int nModifierInterval = 10 * 60; // CloneCoin - time to elapse before new modifier is computed
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "08 May 2015 - BITCOIN PRICE SURGES HIGHER (& HIGHER)";
        CTransaction txNew;
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb1, 0xc6, 0xd6 };
